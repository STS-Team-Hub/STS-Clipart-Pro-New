(function(){
  ...
  var nativeAdapter = ns.nativeProfileAdapter;
  if (!profiles || typeof profiles.register !== 'function' || !nativeAdapter || typeof nativeAdapter.toScannerProfile !== 'function') return;
  ...
  var profile = {
    id: 'interestpod',
    name: 'Interestpod',
    domains: ['interestpod.co'],
    match: function(hostname){ var h = String(hostname || '').toLowerCase(); return h === 'interestpod.co' || h.endsWith('.interestpod.co'); },
    matchHost: function(h){ return h === 'interestpod.co' || h.endsWith('.interestpod.co'); },
    getRoot: getRoot,
    getGroups: getGroups,
  ...
  profiles.register(nativeAdapter.toScannerProfile(profile, { sourceKind: 'scanner-profile-interestpod', scanHints: { phase3CustomilyRollout: true, phase4CustomilyRollout: true, phase5CustomilyRollout: true } }));
})();
