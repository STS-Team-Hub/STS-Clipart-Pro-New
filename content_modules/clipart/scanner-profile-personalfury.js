(function(){
  ...
  profiles.register(nativeAdapter.toScannerProfile(profile, { sourceKind: 'scanner-profile-personalfury', scanHints: { phase3CustomilyRollout: true, phase4CustomilyRollout: true, phase5CustomilyRollout: true } }));
})();
